...
public class BitonicTSP extends Algorithm {
    ...
    private Stack<Integer> shortestPath; // List containing the ids of the vertices that forms the shortest path for the TSP problem
    ...
    public static void printResult(int[][] graph){
        ...
        System.out.println("Bitonic algorithm: ");
        // finding the time before the operation is executed
        start = System.currentTimeMillis();
        // Finds the shortest path cost with the Brunch and bound algorithm
        BitonicTSP bitonicTSP = new BitonicTSP(graph);
        try {
            System.out.println("Path cost: " + bitonicTSP.getShortestPathCost());
            bestPath = bitonicTSP.getShortestPath();
